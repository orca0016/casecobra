...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ...
      : "https://casecobra-lyeqg9wmx-orca0016s-projects.vercel.app";
        ...
        <Body style={main}>
          <Container style={container}>
            <Section style={message}>
              ...
              <Text style={global.text}>
                ...
                your package has ben shipped. Delivery usually takes 2 days.
              </Text>
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you any questions.(if you reply to this
