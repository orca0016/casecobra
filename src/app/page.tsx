    ...
    <div className="bg-slate-50">
      ...
      <section className="bg-slate-100 ">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feels durable and I even got a compliment one the
                  design. Had the case for two and a half months now and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clear
                  </span>{" "}
                  , one the case I had before , the image started fading into
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex ga-1.5 items-center text-zinc-600">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  last phone cases , besides a barely noticeable scratch on the
                  corner ,{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex  flex-col  items-center  md:grid grid-cols-2 gap-40">
              ...
              <div className="relative   h-80  md:h-full  w-full md:justify-self-end  max-w-sm rounded-xl bg-gray-900/5 ring-inset  ring-gray-900/10 lg:rounded-2xl">
                  <img src="/horse.jpg" alt="horse" className="rounded-md  object-cover  bg-white  shadow-2xl right-1  ring-gray-900/10 w-full h-full" />
              </div>
